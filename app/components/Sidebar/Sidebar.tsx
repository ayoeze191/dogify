...
export default  function  Home () {
  ...
  useEffect(() => {
    ...
    return (
      ...
      className={` ${showModal?"translate-y-0":" -translate-y-[60rem] md:translate-y-0 transition-all"} flex flex-col px-2 md:px-4  pt-10 bg-[#f0f8ff] md:h-screen overflow-y-scroll fixed w-full  h-[88vh] md:w-[320px] bottom-0 left-0 z-20`}>
